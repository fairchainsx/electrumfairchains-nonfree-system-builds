...
from electrumfairchains.util import base_units_list
from electrumfairchains.i18n import languages
from electrumfairchains.gui.kivy.i18n import _
from electrumfairchains.plugin import run_hook
from electrumfairchains import coinchooser
...
class SettingsDialog(Factory.Popup):
    ...
    def proxy_dialog(self, item, dt):
        ...
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file('electrumfairchains/gui/kivy/uix/ui_screens/proxy.kv')
