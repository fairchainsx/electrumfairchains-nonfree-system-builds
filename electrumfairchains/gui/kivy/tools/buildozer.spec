...
source.exclude_dirs = bin, build, dist, contrib, electrumfairchains/gui/qt, electrumfairchains/gui/kivy/tools, electrumfairchains/gui/kivy/theming/light
# (list) List of exclusions using pattern matching
source.exclude_patterns = Makefile,setup*

# (str) Application versioning (method 1)
version.regex = APK_VERSION = '(.*)'
version.filename = %(source.dir)s/electrumfairchains/version.py
...
presplash.filename = %(source.dir)s/electrumfairchains/gui/icons/efc_presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/electrumfairchains/gui/icons/efc_launcher.png
...
android.add_src = electrumfairchains/gui/kivy/data/java-classes/
...
android.manifest.intent_filters = electrumfairchains/gui/kivy/tools/faircoin_intent.xml
