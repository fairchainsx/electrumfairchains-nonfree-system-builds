...
from electrumfairchains.bitcoin import TYPE_ADDRESS
from electrumfairchains.storage import WalletStorage
from electrumfairchains.wallet import Wallet, InternalAddressCorruption
from electrumfairchains.paymentrequest import InvoiceStore
from electrumfairchains.util import profiler, InvalidPassword #, send_exception_to_crash_reporter
from electrumfairchains.plugin import run_hook
from electrumfairchains.util import format_satoshis, format_satoshis_plain
from electrumfairchains.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
from electrumfairchains import blockchain
from electrumfairchains.network import Network, TxBroadcastError, BestEffortRequestFailed
from .i18n import _
...
Factory.register('TabbedCarousel', module='electrumfairchains.gui.kivy.uix.screens')

# Register fonts without this you won't be able to use bold/italic...
# inside markup.
from kivy.core.text import Label
Label.register('Roboto',
               'electrumfairchains/gui/kivy/data/fonts/Roboto.ttf',
               'electrumfairchains/gui/kivy/data/fonts/Roboto.ttf',
               'electrumfairchains/gui/kivy/data/fonts/Roboto-Bold.ttf',
               'electrumfairchains/gui/kivy/data/fonts/Roboto-Bold.ttf')


from electrumfairchains.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
class ElectrumWindow(App):
    ...
    def on_qr(self, data):
        from electrumfairchains.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrumfairchains.transaction import Transaction
        from electrumfairchains.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrumfairchains.util import format_time
        requestor = req.get('requestor')
        exp = req.get('exp')
        memo = req.get('memo')
        amount = req.get('amount')
        fund = req.get('fund')
        popup = Builder.load_file('electrumfairchains/gui/kivy/uix/ui_screens/invoice.kv')
    ...
    def build(self):
        return Builder.load_file('electrumfairchains/gui/kivy/main.kv')
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrumfairchains/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrumfairchains.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrumfairchains.gui.kivy.uix.qrcodewidget')
        ...
        self.icon = "electrumfairchains/gui/icons/efc.png"
    ...
    def get_max_amount(self):
        from electrumfairchains.transaction import TxOutput
    ...
    def show_error(self, error, width='200dp', pos=None, arrow_pos=None,
        exit=False, icon='atlas://electrumfairchains/gui/kivy/theming/light/error', duration=0,
        modal=False):
    ...
    def show_info(self, error, width='200dp', pos=None, arrow_pos=None,
        ...
        '''
        self.show_error(error, icon='atlas://electrumfairchains/gui/kivy/theming/light/important',
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://electrumfairchains/gui/kivy/theming/light/card'
        else:
