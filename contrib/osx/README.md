...
This guide explains how to build ElectrumFairChains binaries for macOS systems.
...
This creates both a folder named ElectrumFairChains.app and the .dmg file.
...
Copy the ElectrumFairChains.app directory over and install the dependencies, e.g.:
...
Then you can just invoke `package.sh` with the path to the app:
    ...
    cd electrumfairchains
    ./contrib/osx/package.sh ~/ElectrumFairChains.app/
